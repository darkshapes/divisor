...
class HyperChain:
    ...
    def __init__(self, data=None):
        ...
        if data is not None and "_hyperchain" in data:
    ...
    @chain_file.decorator
    def save_chain_to_file(self, data: str | None = None):  # pylint:disable=unused-argument
    ...
    def load_chain_from_file(self, data: str):
        ...
        for block_data in data["_hyperchain"]:  # type: ignore
            block = Block.from_dict(block_data)  # type: ignore
