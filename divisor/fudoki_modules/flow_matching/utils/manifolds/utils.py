...
from divisor.fudoki_modules.flow_matching.utils.manifolds import Manifold


def geodesic(manifold: Manifold, start_point: Tensor, end_point: Tensor) -> Callable[[Tensor], Tensor]:
