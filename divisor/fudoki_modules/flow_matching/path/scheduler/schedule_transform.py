...
from divisor.fudoki_modules.flow_matching.path.scheduler.scheduler import Scheduler
...
class ScheduleTransformedModel(ModelWrapper):
    ...
    def __init__(
        ...
        assert hasattr(self.original_scheduler, "snr_inverse") and callable(getattr(self.original_scheduler, "snr_inverse")), (
    ...
    def forward(self, x: Tensor, t: Tensor, **extras) -> Tensor:
        ...
        dt_r = sigma_t * sigma_t * (sigma_r * d_alpha_r - alpha_r * d_sigma_r) / (sigma_r * sigma_r * (sigma_t * d_alpha_t - alpha_t * d_sigma_t))
