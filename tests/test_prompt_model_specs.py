...
# assert mir_id in configs, f"Model ID {mir_id} not found in configs"
...
#     spec = get_model_spec(model_id, configs)
#     assert spec.init is not None
...
#     spec = get_model_spec("model.dit.flux1-dev", configs)
...
#     compat_spec = get_model_spec(f"{model_id}:fp8-sai", configs)
